...
module.exports = {
  ...
  async execute(interaction) {
    const sent = await interaction.reply({ content: 'Fetching ping... This might take a while. Please wait', fetchReply: true });
    const MessageEmbed = new EmbedBuilder()
      ...
      .setFooter({ text: `bot made by rrryfoo#8618 (discord.js v14)` });
